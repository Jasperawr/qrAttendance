            ...
            <form action="./update.php" method="POST" id="form" class="flex flex-col gap-5" onsubmit="return validateForm()" enctype="multipart/form-data">
                ...
                <div class="p-5 px-20">
                    <div id="allinputs<?php echo $facultyId; ?>" class="w-full">
                        <!-- Name Input -->
                        <label for="name" class="tracking-wide block mb-1 text-[11px] text-gray-900 uppercase font-bold">New Password</label>
                        ...
                        <!-- Email Input -->
                        <div class="w-full">
                            <label for="email<?php echo $facultyId; ?>" class="tracking-wide block mb-1 text-[11px] text-gray-900 uppercase font-bold">Con Password</label>
                            <input
                                type="password"
                                ...
                                id="confirmpassword<?php echo $facultyId; ?>"
