    ...
    <body>
        ...
        <div class="flex justify-center font-poppins h-screen w-full pt-[120px] bg-gray-50">
            <div class="bg-opacity-75 flex flex-col w-full px-[200px] gap-9">
                ...
                <div class="bg-white px-8 py-3 rounded-lg shadow-md flex flex-col justify-center items-center space-x-4 w-full">

                    <p class="text-xs text-gray-500">You can use this to upload an excel file to add students</p>

                    <!-- Form -->
                    <form action="./add.php" method="post" enctype="multipart/form-data" class="flex gap-4 justify-center items-center w-full">
                        <div>
                            <input
                                type="file"
                                name="excelFile"
